...
namespace Charlotte
{
	public class Canvas
	{
		...
		public Canvas Expand(I2Size size)
		{
			return this.Expand(size.W, size.H);
		}
		...
		/// <summary>
		/// 画像の中身を全て含む最小の矩形領域を返します。
		/// </summary>
		/// <param name="match">中身かどうか</param>
		/// <returns>矩形領域</returns>
		public I4Rect GetEntityRect(Predicate<I4Color> match)
		{
